			...
			<div class="row">
				...
				<div class="col-md-10">
					...
					<form id="formId" enctype="multipart/form-data" action="${basePath}/user/updateSelf.shtml" method="post">
						  ...
						  <div class="form-group">
						    <label for="phone">phone（不准修改）</label>
						    <input type="text" class="form-control " disabled autocomplete="off" id="phone" maxlength="64" name="phone" value="${token.phone?default('未设置')}" placeholder="请输入帐号">
						  </div>
						  <div class="form-group">
